# -*- coding: utf-8 -*-
"""
Created on Wed Sep 14 20:39:18 2016
...
test = tables.open_file('TEST5_features.h5', 'w')
test_table = test.create_table('/', 'TEST5_dataset', Weights)
